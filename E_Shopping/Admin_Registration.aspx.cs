...
namespace E_Shopping
{
    public partial class Admin_Registration : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ins = "insert into Tab_Admin_Registration values(" + user_id + ",'" + TextBox1.Text + "','" + TextBox2.Text + "'," + TextBox3.Text + ")";
            int i = obj.fun_Non_Query(ins);
            if (i != 0)
            {
                string inslog = "insert into Table_Login values(" + user_id + ",'" + TextBox4.Text + "','" + TextBox5.Text + "','admin','active')";
