...
namespace E_Shopping
{
    public partial class Edit_Product : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string update = "update Tab_Product set Product_Name='"+TextBox1.Text+ "',Product_Image='" + p+ "',Product_Price=" + TextBox2.Text+ ",Product_Description='" + TextBox3.Text+ "',Product_Stock='" + TextBox4.Text+ "',Product_Status='" + DropDownList1.SelectedItem.Text+"'";
        ...
        protected void LinkButton2_Command(object sender, CommandEventArgs e)
        {
            int id = Convert.ToInt32(e.CommandArgument);
               string d = "delete from Tab_Product where Product_Id='" + id + "'";
        ...
        protected void LinkButton3_Command(object sender, CommandEventArgs e)
        {
            ...
            {
                string d = "update Tab_Product set Product_Status='Available' where Product_Id=" + pid1 + "";
